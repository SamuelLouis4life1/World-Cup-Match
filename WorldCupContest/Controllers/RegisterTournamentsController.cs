...
namespace WorldCupContest.Controllers
{
    public class RegisterTournamentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,TournamentName,TournamentDate,AwayHomeGame")] RegisterTournament registerTournament)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,TournamentName,TournamentDate,AwayHomeGame")] RegisterTournament registerTournament)
        {
